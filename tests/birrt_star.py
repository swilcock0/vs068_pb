...
for i in range(1, len(goals)):
    path_section, success = birrt_star(path_section[-1], goals[i], n_it = 99999, time_limit = 2.0, tool_space=False, step=0.1, tolerance=tolerance, collision_fn=collision_fn)

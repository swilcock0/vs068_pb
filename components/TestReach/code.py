...
display = sc.sticky.get("display", r.Display.CustomDisplay(True))
...
if preview == True and preview != None:
    ...
    for i in range(len(X)):
        ...
        sc.sticky["display"] = display
else:
    display.Clear()
    display.Dispose()
    del sc.sticky["display"]
